...
/**
 * Generates a JWT containing a payload with the user id from mongodb
 * @param {*} user - The user object from mongodb.  We need this to set the JWT `sub` payload property to the MongoDB user ID
 */
